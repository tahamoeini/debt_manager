      ...
      body: ListView(
        ...
        children: [
                    ...
                    children: [
                      ...
                      ...insights.map((insight) => Padding(
                        ...
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('• ', style: TextStyle(color: cs.onPrimaryContainer)),
                            Expanded(
                              child: Text(
                                insight,
          ...
          FutureBuilder<Map<String, int>>(
            future: _repo.getSpendingByCategory(_selectedYear, _selectedMonth),
            builder: (context, snap) {
              if (snap.connectionState == ConnectionState.waiting) {
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      spots: data.asMap().entries.map((e) {
                        final index = e.key;
                        final item = e.value;
                        final netWorth = (item['netWorth'] as int? ?? 0).toDouble();
