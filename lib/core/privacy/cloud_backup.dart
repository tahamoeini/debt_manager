abstract class CloudBackupProvider {
  ...
  Future<String> uploadEncryptedBlob(List<int> bytes, {required String filename});
...
class NoopCloudBackupProvider implements CloudBackupProvider {
  @override
  Future<List<int>> downloadEncryptedBlob(String id) async => throw UnimplementedError();

  @override
  Future<List<String>> listBackups() async => [];

  @override
  Future<String> uploadEncryptedBlob(List<int> bytes, {required String filename}) async => throw UnimplementedError();
}
